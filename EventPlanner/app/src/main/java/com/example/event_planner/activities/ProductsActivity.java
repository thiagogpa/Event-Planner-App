...
import com.example.event_planner.fragments.ProductsFragment;
import com.google.android.material.tabs.TabLayout;

import androidx.fragment.app.Fragment;
import androidx.viewpager.widget.ViewPager;

import com.example.event_planner.ui.main.TabAdapter;
...
public class ProductsActivity extends Base {
    ...
    public void NextActivity(View view) {
        ...
        Intent chartActivity = new Intent(getApplicationContext(), SummaryActivity.class);
        chartActivity.putExtra(getString(R.string.INTENT_KEY), currentEvent);
